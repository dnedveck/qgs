...
```{r}
# opts_chunk$set(tidy = FALSE, fig.height=4, cache=TRUE)
...
So, my mean time spent on campus is 9.1hrs per day.
...
ggplot(weekclock, aes(x=weekcampus)) + 
    ...
    geom_density(alpha=.3, fill="black")
```
I guess I really don't have enough points to see an interesting distribution. Might be skewed to the left, or bimodal. 
